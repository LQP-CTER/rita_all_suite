// File: Rita_All_Django/static/js/tiktok_analyzer.js
// Đã hoàn nguyên: Xóa bỏ logic xử lý và hiển thị dự đoán.
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (analyzeForm) {
        ...
        function displayAnalysis(analysisData) {
            analysisOutput.innerHTML = ''; // Clear "Đang phân tích..."
            if (typeof analysisData === 'object' && analysisData !== null) {
                ...
                if (analysisData.key_topics && analysisData.key_topics.length > 0) {
                    ...
                    analysisData.key_topics.forEach(topic => {
        ...
        function addVideoToHistory(videoData, originalUrl) {
            ...
            card.innerHTML = `
                ...
                <img src="${videoData.cover_url}" alt="Video cover" class="history-card-cover" onerror="this.src='https://placehold.co/400/111827/94a3b8?text=No+Cover'">
        ...
        async function handleAnalysis(event) {
            ...
            loadingIndicator.style.display = 'flex'; // Use flex to center spinner
            ...
            try {
                ...
                if (response.ok && data.status === 'processing') {
                    ...
                    videoCover.src = video.cover_url || 'https://placehold.co/600x900/111827/94a3b8?text=No+Cover';
                    ...
                    analysisOutput.innerHTML = '<p>Đang phân tích AI, vui lòng chờ...</p>';
